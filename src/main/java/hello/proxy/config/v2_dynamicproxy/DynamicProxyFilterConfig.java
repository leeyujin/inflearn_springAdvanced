...
public class DynamicProxyFilterConfig {
    ...
    private static final String[] PATTERNS = {"reqeust*", "order*", "save*"};

    @Bean
    public OrderControllerV1 orderController(LogTrace logTrace){
        OrderControllerV1 controllerImpl = new OrderControllerV1Impl(orderService(logTrace));
        LogTraceFilterHandler handler = new LogTraceFilterHandler(controllerImpl, logTrace, PATTERNS);
    ...
    public OrderServiceV1 orderService(LogTrace logTrace) {
        ...
        LogTraceFilterHandler handler = new LogTraceFilterHandler(serviceImpl, logTrace, PATTERNS);
    ...
    public OrderRepositoryV1 orderRepository(LogTrace logTrace) {
        ...
        LogTraceFilterHandler handler = new LogTraceFilterHandler(repositoryImpl, logTrace, PATTERNS);
